...
const CountryDD=({all,sel,onChange})=>{
  ...
  return(
    <div ref={ref} style={{position:'relative'}}>
      ...
      {open&&<div style={{position:'absolute',top:'calc(100% + 4px)',left:0,background:'var(--surface)',border:'1px solid #e8e8e8',borderRadius:12,boxShadow:'0 4px 24px rgba(0,0,0,0.1)',zIndex:100,minWidth:165,padding:'6px 0',animation:'modalIn .12s cubic-bezier(.34,1.56,.64,1) forwards'}}>
