const PageHeader=({icon,iconBg,iconColor,title,subtitle,right})=>(
  <div className="page-header">
    ...
    <div style={{flex:1,minWidth:0}}>
      <h2 style={{fontSize:24,fontWeight:700,color:'var(--text)',margin:0,lineHeight:1.3}}>{title}</h2>
      {subtitle&&<p style={{color:'var(--text-muted)',fontSize:14,margin:'2px 0 0',lineHeight:1.4}}>{subtitle}</p>}
    </div>
