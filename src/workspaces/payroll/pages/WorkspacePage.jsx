...
const SOURCES = [
  {
    id: 'zendesk',
    name: 'Zendesk',
    description: 'Payroll support tickets and customer requests.',
  },
  {
    id: 'jira',
    name: 'Jira',
    description: 'Engineering escalations and cross-team payroll issues.',
  },
  {
    id: 'workbench',
    name: 'Workbench',
    description: 'Payroll cycle tasks and internal work items.',
  },
];
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 14, color: '#6b6b6b', margin: '6px 0 20px' }}>
        Three sources will feed the Payroll queue once each integration is provisioned with its own
        API credentials.
      </p>
