...
export default function HomePage() {
  return (
    <div>
      <h1 style={{ fontSize: 24, fontWeight: 700, margin: 0 }}>GIX Hub</h1>
      ...
      <div style={card}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18, fontSize: 13, color: '#6b6b6b', lineHeight: 1.8 }}>
          ...
          <li><strong>OOO</strong> — out-of-office coverage and handovers for the GIX team.</li>
          <li><strong>Urgent Assist</strong> — escalation queue for time-sensitive immigration requests.</li>
